...
if (Util.hasClass = function(e, t) {
        ...
        e.prototype.addDropdownEvents = function() {
            ...
            this.element.addEventListener("keydown", function(e) {
                ...
                if (e.keyCode && 9 == e.keyCode || e.key && "Tab" == e.key) {
                    var t = document.activeElement,
                        s = t.closest(".js-dropdown__menu"),
                        i = t.nextElementSibling;
                    if (s && !Util.hasClass(s, "dropdown__menu--is-visible") && o.showLevel(s), i && !Util.hasClass(i, "dropdown__menu--is-visible") && o.showLevel(i), !o.prevFocus) return;
                    var n = o.prevFocus.closest(".js-dropdown__menu"),
                        l = o.prevFocus.nextElementSibling;
                    if (!n) return;
                    if (s && s == n) return void(l && o.hideLevel(l));
                    if (l && s && s == l) return;
                    if (i && n && i == n) return;
                    var a = s.parentNode.closest(".js-dropdown__menu");
                    if (a && a == n) return void(l && o.hideLevel(l));
                    n && Util.hasClass(n, "dropdown__menu--is-visible") && o.hideLevel(n)
                }
            })
            ...
            Util.addClass(e, "dropdown__menu--is-visible"), Util.removeClass(e, "dropdown__menu--hide")
        }, e.prototype.hideLevel = function(s, i) {
            Util.hasClass(s, "dropdown__menu--is-visible") && (Util.removeClass(s, "dropdown__menu--is-visible"), Util.addClass(s, "dropdown__menu--hide"), s.addEventListener("transitionend", function e(t) {
                "opacity" == t.propertyName && (s.removeEventListener("transitionend", e), Util.hasClass(s, "dropdown__menu--hide") && Util.removeClass(s, "dropdown__menu--hide dropdown__menu--left"), i && !Util.hasClass(s, "dropdown__menu--is-visible") && s.setAttribute("style", "width: 0px; overflow: hidden;"))
            }))
        }, window.Dropdown = e;
...
if (Util.addClass = function(e, t) {
        ...
        e.prototype.initTab = function() {
            ...
            var l = this;
            this.tabList.addEventListener("mouseover", function(e) {
                e.target.closest(".js-tabs__trigger") && l.triggerTab(e.target.closest(".js-tabs__trigger"), e)
            }), this.tabList.addEventListener("keydown", function(e) {
                var t, s, i, n;
                e.target.closest(".js-tabs__trigger") && (i = e, "horizontal" == (n = l.layout) && (i.keyCode && 39 == i.keyCode || i.key && "ArrowRight" == i.key) || "vertical" == n && (i.keyCode && 40 == i.keyCode || i.key && "ArrowDown" == i.key) ? (e.preventDefault(), l.selectNewTab("next")) : (t = e, ("horizontal" == (s = l.layout) && (t.keyCode && 37 == t.keyCode || t.key && "ArrowLeft" == t.key) || "vertical" == s && (t.keyCode && 38 == t.keyCode || t.key && "ArrowUp" == t.key)) && (e.preventDefault(), l.selectNewTab("prev"))))
            })
...
Util.hasClass = function(e, t) {
    ...
    function() {
        var e = function(e) {
            ...
            this.element = e, this.search = this.element.getElementsByClassName("js-mega-nav__search"), this.searchActiveController = !1, this.menu = this.element.getElementsByClassName("js-mega-nav__nav"), this.menuItems = this.menu[0].getElementsByClassName("js-mega-nav__item"), this.menuActiveController = !1, this.itemExpClass = "mega-nav__item--expanded", this.classIconBtn = "mega-nav__icon-btn--state-b", this.classSearchVisible = "mega-nav__search--is-visible", this.classNavVisible = "mega-nav__nav--is-visible", this.classMobileLayout = "mega-nav--mobile", this.classDesktopLayout = "mega-nav--desktop", this.layout = "mobile", this.dropdown = this.element.getElementsByClassName("js-dropdown"), this.expandedClass = "mega-nav--expanded", this.hover = this.element.getAttribute("data-hover") && "on" == this.element.getAttribute("data-hover"), s(t = this),
                ...
                function(s) {
                    ...
                    if ("desktop" == l.layout) {
                        var t = e.target.closest(".js-mega-nav__item");
                        if (t) {
                            var s = t.getElementsByClassName("js-mega-nav__control");
                            if (!(s.length < 1)) {
        ...
        function n(e) {
            Util.hasClass(e.search[0], e.classSearchVisible) && !document.activeElement.closest(".js-mega-nav__search") && o(e, e.search[0], "searchActiveController", e.classSearchVisible, e.searchActiveController, !0), Util.hasClass(e.menu[0], e.classNavVisible) && !document.activeElement.closest(".js-mega-nav__nav") && o(e, e.menu[0], "menuActiveController", e.classNavVisible, e.menuActiveController, !0);
            for (var t = 0; t < e.menuItems.length; t++)
                if (Util.hasClass(e.menuItems[t], e.itemExpClass)) {
                    var s = document.activeElement.closest(".js-mega-nav__item");
        ...
        function r(e, t, s) {
            var i = t.target.closest(".js-mega-nav__control");
            if (i) {
                var n = i.closest(".js-mega-nav__item");
                if (n) {
        ...
        function l(e, t) {
            ...
            var s = e.menuItems[t].getElementsByClassName("js-mega-nav__control");
        ...
        var t, c = document.getElementsByClassName("js-mega-nav");
        if (0 < c.length) {
            ...
            window.addEventListener("keyup", function(e) {
                ...
                e.target.closest(".js-mega-nav") || i(h[0])
            });
            var v = !1,
