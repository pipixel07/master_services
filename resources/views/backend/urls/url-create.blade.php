...
<div class="app-content my-3 my-md-5">
    <div class="side-app">
        ...
        <div class="page-header">
            <h1 class="page-title">Add New Url</h1>
            <ol class="breadcrumb">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-content">
                            <form action="{{ url('/admin/urls') }}" method="POST" enctype="multipart/form-data" id="form">
                                @csrf
                                    ...
                                    <div class="table-responsive">
                                        <div class="control-group form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder=" Name" name="title" required value="{{old('title')}}" />
                                            </div>
