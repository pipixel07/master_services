		...
		<div id="global-loader">
			<img src={{asset("common/assets/images/loader.svg")}} class="loader-img" alt="loader">
		</div>
		<!--/Loader-->
				...
				<aside class="app-sidebar doc-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
						 ...
						 <li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href={{url('admin/applied')}}>Applied Jobs</a></li>
						 ...
						 <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-folder"></i><span class="side-menu__label">Testimonials</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a class="slide-item" href={{url('admin/testimonial')}}>All Testimonials</a></li>
								<li><a class="slide-item" href={{url('admin/testimonial/create')}}>Add Testimonials</a></li>

							</ul>
						</li> 
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-folder"></i><span class="side-menu__label">Settings</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a class="slide-item" href={{url('admin/mail-configuration')}}>Mail Configuration</a></li>
								<li><a class="slide-item" href={{url('admin/settings')}}>Receiver Mail</a></li>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-folder"></i><span class="side-menu__label">Settings</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a class="slide-item" href={{url('admin/scripts')}}>Manage scripts</a></li>
								<li><a class="slide-item" href={{url('admin/urls')}}>Manage URL's</a></li>
								<li><a class="slide-item" href={{url('admin/mailers')}}>Manage Mailers</a></li>
								<li><a class="slide-item" href={{url('admin/gallery')}}>Manage Gallery</a></li>
								<li><a class="slide-item" href={{url('admin/metatags')}}>Manage Meta Tags</a></li>
